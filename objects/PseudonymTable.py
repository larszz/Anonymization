...
class PseudonymTable:
	...
	def __init__(self, use_readable_pseudonyms=False, fieldnames=None, new_fieldname=None):
	...
	def get_new_fieldname(self):
		if self.new_fieldname is None:
			self.new_fieldname = self.generate_new_fieldname()
	...
	def generate_new_fieldname(self):
		output = ''
		for f in self.fieldnames:
			output += str(f) + '_'
		output.rstrip('_')
